...
// Funktion, um Pokemon-Daten zu initialisieren
async function init() {
...
function getPokeTypes(data, i) {
    for (let j = 0; j < data.types.length; j++) {
        ...
        // Setze den Text des neuen divs
        typeDiv.textContent = type.type.name;

        // Füge das neue div zum Element mit der ID types${i} hinzu
